@STATIC;1.0;I;21;Foundation/CPString.ji;8;CPView.ji;9;CPColor.ji;14;CPColorPanel.jt;8488;objj_executeFile("Foundation/CPString.j", NO);
...
{ with(self)
{
    ...
    {
        _active = NO;
        _bordered = objj_msgSend(aCoder, "decodeBoolForKey:", CPColorWellBorderedKey);
